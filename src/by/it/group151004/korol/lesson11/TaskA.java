package by.it.group151004.korol.lesson11;

import java.util.Arrays;
import java.util.LinkedList;

/*
Примените алгоритм поиска в глубину к данному графу, перебирая вер-
шины в алфавитном порядке. Пометьте каждое ребро как древесное или об-
ратное, а также вычислите рге- и роst- значения для каждой вершины.
*/
